    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="bg-white border-b border-gray-100 text-center px-6 py-8">
          <div className="inline-block bg-emerald-50 text-emerald-700 text-[11px] font-semibold px-3 py-1 rounded-full mb-3 tracking-wide uppercase">
            Free delivery over R500
          </div>
          <h1 className="text-2xl font-semibold text-gray-900 mb-2">Your daily wellness, delivered</h1>
